...
from common.lib.xmodule.xmodule.modulestore.django import modulestore as store  # lint-amnesty, pylint: disable=wrong-import-order
...
from common.lib.xmodule.xmodule.xml_module import XmlParserMixin  # lint-amnesty, pylint: disable=wrong-import-order
