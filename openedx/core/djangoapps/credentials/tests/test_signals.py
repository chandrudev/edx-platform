...
from common.lib.xmodule.xmodule.modulestore.tests.factories import CourseFactory as XModuleCourseFactory  # lint-amnesty, pylint: disable=wrong-import-order
