...
from common.lib.xmodule.xmodule import block_metadata_utils, course_metadata_utils  # lint-amnesty, pylint: disable=wrong-import-order
from common.lib.xmodule.xmodule.course_module import DEFAULT_START_DATE, CourseBlock  # lint-amnesty, pylint: disable=wrong-import-order
...
class LiveClasses(models.Model):
    ...
    topic_name = models.CharField(max_length=60, null=True , unique=True)
