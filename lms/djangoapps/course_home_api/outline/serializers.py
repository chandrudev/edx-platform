    ...
    def get_blocks(self, block):  # pylint: disable=missing-function-docstring
        ...
        serialized = {
            block_key: {
                ...
                'icon': icon,
                'id': block_key,
                'lms_web_url': block['lms_web_url'].replace("http://student","http://preview.student") if enable_links else None,
                'legacy_web_url': block['legacy_web_url'].replace("http://student","http://preview.student") if enable_links else None,
