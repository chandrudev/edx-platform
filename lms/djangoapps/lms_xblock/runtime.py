...
from common.lib.xmodule.xmodule.modulestore.django import ModuleI18nService, modulestore  # lint-amnesty, pylint: disable=wrong-import-order
from common.lib.xmodule.xmodule.partitions.partitions_service import PartitionService  # lint-amnesty, pylint: disable=wrong-import-order
from common.lib.xmodule.xmodule.services import SettingsService, TeamsConfigurationService  # lint-amnesty, pylint: disable=wrong-import-order
from common.lib.xmodule.xmodule.x_module import ModuleSystem  # lint-amnesty, pylint: disable=wrong-import-order
