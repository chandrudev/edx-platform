...
from common.lib.xmodule.xmodule.partitions.partitions_service import get_all_partitions_for_course  # lint-amnesty, pylint: disable=wrong-import-order
...
def get_proctored_exam_settings_url(course_locator) -> str:
    ...
    if exam_setting_view_enabled():
        mfe_base_url = get_course_authoring_url(course_locator)
        log.info(f"+++++++++++++++++++++++++++mfe base url++++++++++++++++++{mfe_base_url}++++++++++++++++++++++++++++++++++++")
        course_mfe_url = f'{mfe_base_url}/course/{course_locator}'
        log.info(f"++++++++++++++++++++++++CALLING MFE URL++++++++++++++++++++++++++++{course_mfe_url}")
        if mfe_base_url:
