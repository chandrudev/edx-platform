...
from common.lib.xmodule.xmodule.capa_module import ProblemBlock  # lint-amnesty, pylint: disable=wrong-import-order
from common.lib.xmodule.xmodule.x_module import AUTHOR_VIEW  # lint-amnesty, pylint: disable=wrong-import-order
